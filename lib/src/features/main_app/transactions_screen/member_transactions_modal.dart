...
class MemberTransactionsModal extends StatefulWidget {
  ...
  static Future<void> show(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => const MemberTransactionsModal(),
    );
  }

  @override
  State<MemberTransactionsModal> createState() => _MemberTransactionsModalState();
}

class _MemberTransactionsModalState extends State<MemberTransactionsModal> {
  ...
  // Fetch all transactions for member, sorted latest first
  ...
  Future<void> _markTransactionAsReturned(Map<String, dynamic> tx) async {
    ...
    try {
      ...
      // 2. Restore stock for each component in its respective category table
  ...
  Widget _buildTransactionsContent() {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final status = (tx['status']?.toString() ?? 'Issued').trim();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Action Buttons Row (Mark as Returned & Apply Fine)
                Row(
